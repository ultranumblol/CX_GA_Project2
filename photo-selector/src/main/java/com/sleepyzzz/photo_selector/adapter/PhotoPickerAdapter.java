...
public class PhotoPickerAdapter extends CommonAdapter<String> {
    ...
    public void convert(final ViewHolder helper, final String item) {
        ...
        helper.setImageResource(R.id.iv_checkmark, R.drawable.selectbox_n);
        ...
        mCheckMark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mSelectedImage.contains(mDirPath + "/" + item)) {
                    ...
                    mCheckMark.setImageResource(R.drawable.selectbox_n);
                    //mask.setVisibility(View.GONE);
                } else {
                    //未选择该图片
                    ...
                    mOnItemClickListerner.onMarkClick(mDirPath + "/" +item);    //回调
                    mCheckMark.setImageResource(R.drawable.selectbox_marked);
